...
class MockApiDataSource implements ApiDataSource {
  ...
  Future<List<TransactionModel>> getAccountTransactions(
    ...
    return [
      TransactionModel(
        ...
        date: now.subtract(Duration(days: pageOffset * 10 + 1)).toIso8601String(),
        amount: -45.99,
      ...
      TransactionModel(
        ...
        date: now.subtract(Duration(days: pageOffset * 10 + 2)).toIso8601String(),
        amount: 2500.00,
      ...
      TransactionModel(
        ...
        date: now.subtract(Duration(days: pageOffset * 10 + 3)).toIso8601String(),
        amount: -120.50,
      ...
      TransactionModel(
        ...
        date: now.subtract(Duration(days: pageOffset * 10 + 5)).toIso8601String(),
        amount: -89.99,
      ...
      TransactionModel(
        ...
        date: now.subtract(Duration(days: pageOffset * 10 + 7)).toIso8601String(),
        amount: 150.00,
        description: 'Refund',
        type: 'credit',
      ),
  ...
  @override
  Future<TransferResponseModel> createTransfer(Map<String, dynamic> transferData) async {
    // Simulate network delay
